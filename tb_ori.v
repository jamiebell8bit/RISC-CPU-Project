...
module tb_ori;
    ...
    initial begin
        ...
        // ori R7, R4, 0x71 ; choose R4 = 0x02
        DUT.R4.q = 32'h00000002;
        DUT.PC.q = 32'h00000000;
        fetch_instr({5'b01011, 4'd7, 4'd4, 19'h00071});

        Grb = 1'b1; Rout = 16'h0001; Yin = 1'b1;
        tick();

        Cout = 1'b1; opcode = 5'b00011; Zin = 1'b1;
        tick();

        Gra = 1'b1; Zlowout = 1'b1; Rin = 16'h0001;
        tick();

        $display("ori: R7=%h expected 00000073", DUT.R7.q);
        if (DUT.R7.q !== 32'h00000073) $display("FAIL: ori");
        else $display("PASS: ori");
        #20; $stop;
    end
endmodule
