...
module tb_ldi_direct;
    ...
    initial begin
        ...
        // Case: ldi R7, 0x65
        DUT.PC.q = 32'h00000000;
        fetch_instr({5'b10001, 4'd7, 4'd0, 19'h00065});
        ...
        $display("ldi_direct: R7=%h expected 00000065", DUT.R7.q);
        if (DUT.R7.q !== 32'h00000065) $display("FAIL: ldi direct");
        else $display("PASS: ldi direct");
        #20; $stop;
    end
endmodule
