...
module tb_addi;
    ...
    initial begin
        ...
        // addi R7, R4, -9 ; choose R4 = 20 so result = 11
        DUT.R4.q = 32'h00000014;
        DUT.PC.q = 32'h00000000;
        fetch_instr({5'b01001, 4'd7, 4'd4, 19'h7FFF7}); // -9 in 19-bit two's complement

        Grb = 1'b1; Rout = 16'h0001; Yin = 1'b1;
        tick();
        ...
        $display("addi: R7=%h expected 0000000B", DUT.R7.q);
        if (DUT.R7.q !== 32'h0000000B) $display("FAIL: addi");
        else $display("PASS: addi");
        #20; $stop;
    end
endmodule
