...
module tb_ld_indexed;
    ...
    initial begin
        ...
        // Case: ld R0, 0x72(R2) with R2=0x57 and (0xC9)=0x2B
        DUT.R2.q = 32'h00000057;
        DUT.RAM0.mem[9'h0C9] = 32'h0000002B;
        DUT.PC.q = 32'h00000000;

        fetch_instr({5'b10000, 4'd0, 4'd2, 19'h00072});
        ...
        $display("ld_indexed: R0=%h expected 0000002B", DUT.R0.q);
        if (DUT.R0.q !== 32'h0000002B) $display("FAIL: ld indexed");
        else $display("PASS: ld indexed");
        #20; $stop;
    end
endmodule
