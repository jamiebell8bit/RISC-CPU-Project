...
module tb_st_indexed;
    ...
    initial begin
        ...
        // Case: st 0x1F(R6), R6 ; R6=0x63 and (0x82)=0xA7 -> expect mem[0x82]=0x63
        DUT.R6.q = 32'h00000063;
        DUT.RAM0.mem[9'h082] = 32'h000000A7;
        DUT.PC.q = 32'h00000000;
        fetch_instr({5'b10010, 4'd6, 4'd6, 19'h0001F});
        ...
        $display("st_indexed: mem[82]=%h expected 00000063", DUT.RAM0.mem[9'h082]);
        if (DUT.RAM0.mem[9'h082] !== 32'h00000063) $display("FAIL: st indexed");
        else $display("PASS: st indexed");
        #20; $stop;
    end
endmodule
